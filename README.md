...
This application includes user authentication, dark mode, sort movies on the basis of categories or genres, viewing a movie and actor details, adding a movie to favorites or watchlist and many more functionalities. 

Alan works as in-app voice assistant which creates conversational experiences for Movies.
